...
pub unsafe trait SIMD256: SIMD128 {
    ...
    fn u8x32_splat(self, x: u8) -> Self::V256 {
        simd256_double(self, || self.u8x16_splat(x))
    }

    #[inline(always)]
    fn u16x16_splat(self, x: u16) -> Self::V256 {
        simd256_double(self, || self.u16x8_splat(x))
    }

    #[inline(always)]
    fn u32x8_splat(self, x: u32) -> Self::V256 {
        simd256_double(self, || self.u32x4_splat(x))
    }

    #[inline(always)]
    fn u64x4_splat(self, x: u64) -> Self::V256 {
        simd256_double(self, || self.u64x2_splat(x))
    }

    #[inline(always)]
    fn i8x32_splat(self, x: i8) -> Self::V256 {
        simd256_double(self, || self.i8x16_splat(x))
    }

    #[inline(always)]
    fn i16x16_splat(self, x: i16) -> Self::V256 {
        simd256_double(self, || self.i16x8_splat(x))
    }

    #[inline(always)]
    fn i32x8_splat(self, x: i32) -> Self::V256 {
        simd256_double(self, || self.i32x4_splat(x))
    }

    #[inline(always)]
    fn i64x4_splat(self, x: i64) -> Self::V256 {
        simd256_double(self, || self.i64x2_splat(x))
    }
